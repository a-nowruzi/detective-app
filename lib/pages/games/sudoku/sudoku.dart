...
class _SudokuState extends State<Sudoku> {
    ...
    getPrefs().whenComplete(() {
      ...
      if (currentTheme == null) {
        if (MediaQuery.maybeOf(context)?.platformBrightness != null) {
          currentTheme = MediaQuery.of(context).platformBrightness == Brightness.light ? 'light' : 'dark';
        } else {
          currentTheme = 'dark';
        }
  ...
  showOptionModalSheet(BuildContext context) {
    showModalBottomSheet(
        ...
        builder: (context) {
          final TextStyle customStyle = TextStyle(inherit: false, color: Styles.foregroundColor);
          return Wrap(
            children: [
              ListTile(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  Timer(const Duration(milliseconds: 200), () => newGame(currentDifficultyLevel!));
                },
              ),
              ListTile(
                leading: Icon(Icons.lightbulb_outline_rounded, color: Styles.foregroundColor),
              ...
              ListTile(
                leading: Icon(Icons.build_outlined, color: Styles.foregroundColor),
                ...
                onTap: () {
                  ...
                  Timer(const Duration(milliseconds: 300), () {
                    ...
                    //     builder: (_) => AlertDifficultyState(currentDifficultyLevel!)).whenComplete(() {
              ...
              ListTile(
                leading: Icon(Icons.invert_colors_on_rounded, color: Styles.foregroundColor),
              ...
              ListTile(
                leading: Icon(Icons.color_lens_outlined, color: Styles.foregroundColor),
                ...
                onTap: () {
                  ...
                  Timer(const Duration(milliseconds: 200), () {
                    ...
                    //     duration: const Duration(milliseconds: 350),
                    //     context: outerContext,
                    //     builder: (_) => AlertAccentColorsState(currentAccentColor!)).whenComplete(() {
                    //   if (AlertAccentColorsState.accentColor != null) {
                    //     Timer(const Duration(milliseconds: 300), () {
                    //       currentAccentColor = AlertAccentColorsState.accentColor;
